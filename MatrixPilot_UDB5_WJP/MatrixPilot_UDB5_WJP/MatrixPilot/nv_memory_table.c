...
const mavlink_parameter_block    mavlink_parameter_blocks[] = {
    ...
    { STORAGE_HANDLE_THROTTLE_HEIGHT_OPTIONS , 44 , 9 , STORAGE_FLAG_LOAD_AT_STARTUP | STORAGE_FLAG_LOAD_AT_REBOOT , NULL },
    { STORAGE_HANDLE_AIRSPEED_OPTIONS , 53 , 10 , STORAGE_FLAG_LOAD_AT_STARTUP | STORAGE_FLAG_LOAD_AT_REBOOT , NULL },
    };
